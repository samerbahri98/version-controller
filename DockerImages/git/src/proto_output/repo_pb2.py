...
_GETCOMMIT = _descriptor.ServiceDescriptor(
  name='getCommit',
  full_name='git.getCommit',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='getHeadCommit',
    full_name='git.getCommit.getHeadCommit',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    name='findAllCommits',
    full_name='git.getCommit.findAllCommits',
    index=1,
    containing_service=None,
    input_type=_REPO,
...
_sym_db.RegisterServiceDescriptor(_GETCOMMIT)

DESCRIPTOR.services_by_name['getCommit'] = _GETCOMMIT
